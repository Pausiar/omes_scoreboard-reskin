...
-- Key Bindings
Config.OpenKey = 57         -- F10 key

-- Scoreboard Settings
Config.RefreshInterval = 5000  -- Update interval in ms
Config.ScoreboardTitle = "Lista"  -- Title displayed at the top of the scoreboard
Config.Position = "center"  -- Position of the scoreboard: "left", "center", or "right"
