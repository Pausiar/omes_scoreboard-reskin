document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateControlsInfo() {
        ...
        if (footer) {
            footer.innerHTML = 'Pulsa F10 para cerrar | Flechas para scroll';
        }
    }
    ...
    function updatePlayerList(players) {
        ...
        if (players.length === 1) {
            onlineCount.textContent = `1 Jugador Online`;
        } else {
            onlineCount.textContent = `${players.length} Jugadores Online`;
        }
